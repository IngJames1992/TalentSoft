        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <tr rowspan="3">
                        <td ><a href=""><center><img src="https://i.ibb.co/YcF0MtG/Logo.jpg" alt="cropped-Recurso-2-1024x273-2" border="0"></center></a>
                        </td>
                        ...
                        <td class="border"><a href=""><center><img src="https://i.ibb.co/W2xcr0H/foto.jpg" alt="Logo" border="0"></center></a>
                        </td>
                    </tr>
                    </table>
                </div>
                    ...
                    <div>
                        ...
                        <tr>
                            ...
                            <td style ="font-size:70%"><b>BARRIO/ESTRATO: </b><?php echo $filaacu1['barrio']." / ".$filaacu1['estrato']?></td>
                        ...
                        <tr>
                            <td colspan="3"><b>POR QUE MEDIO DESEA RECIBIR INFORMACION: </b><br><?php echo $filaacu2['medio_contacto'] ?></td>
                        </tr>
                    ...
                    <div>
                        ...
                        <tr>
                            <td>
                                <p  style="text-align: justify; font-size:100%">Como constancia de lo anterior se firma el presente protocolo avalado por el Manual de Convivencia 
                                ...
                                <p  style=" font-size:100%">1.   Cumplir con los compromisos y recomendaciones académicos y de convivencia social definidos por la institución educativa.  Art. 13 Decreto 1290. <br>
                                    ...
                                    3.   Cumplir con todas las disposiciones del Pacto de Convivencia, planes de área y lo dispuesto en el PEI.
                                </p>
                                <br> <br>
