...
<table align="center" border="1px">
                        <tr rowspan="3">
                            <td  
                                class="border"><a href=""><center><img src="SEM_Tulua.png"  ></center></a>
                            </td>
...
<!-- Envuelva el contenido de su PDF dentro de una etiqueta principal -->
    ...
    <br>
                ...
                <table >
                    ...
                    ?>
                    <p  style="text-align: justify;"><b>MARTHA LUCIA TRIANA PÉREZ</b>, mayor de edad, vecina y residente en TULUA, identificada con cédula de ciudadanía 
                       ...
                       y <b><?php echo $filaacu1['nombre']." ".$filaacu1['apellido']?> </b>en su calidad de padres y/o acudientes del (la) alumno(a) <b><?php echo $fila['nombre']." ".$fila['apellido']?> </b> se denominaran PADRES 
                       DE FAMILIA Y/O ACUDIENTES, acuerdan celebrar el presente Contrato de Prestación de Servicios Educativos - 2024. DECLARANDOSE
                    ...
                    <p  style="text-align: justify;"><b>PRIMERA: DEFINICION DEL CONTRATO. </b>El presente contrato formaliza la vinculación del EDUCANDO al servicio educativo que ofrece EL COLEGIO, 
                    ...
                    ?>      
                    <p  style="text-align: justify;"><b>SEGUNDA – OBJETIVO DEL CONTRATO. </b>El objetivo del presente contrato es procurar la formación integral del EDUCANDO mediante la recíproca complementación de esfuerzos 
                    ...
                    <p  style="text-align: justify;"><b>TERCERA – OBLIGACIONES ESENCIALES DEL CONTRATO. </b>Son obligaciones de la esencia del presente contrato para cumplir con el fin común de la educación del EDUCANDO, las siguientes. 
                    ...
                    <p  style="text-align: justify;"><b>CUARTA. DURACION Y RENOVACION. </b>El presente contrato tiene una vigencia de un (1) año lectivo contado a partir del  1 de febrero de 2024 hasta el 30 de Noviembre de 2024; su ejecución será 
                        sucesiva por periodos mensuales y podrá renovarse, en cada respectivo año escolar, previa la firma de un nuevo contrato, siempre y cuando el <b>ESTUDIANTE</b> y los <b>PADRES DE FAMILIA Y/O ACUDIENTES</b> hayan cumplido estrictamente las 
                    ...
                    <p  style="text-align: justify;"><b>QUINTA: VALOR. </b>El presente contrato tiene un costo anual de: <b>UN MILLON SETECIENTOS TREINTA MIL PESOS M/CTE ($ 1.730.000)</b> Para los grados <b>Pre – Jardín, Jardín Transición, Primero, Segundo, Tercero, 
                        Cuarto, Quinto</b>; el cual será cancelado así: <b>POR MATRICULA</b>, la suma de <b>DOSCIENTOS TREINTA MIL PESOS MCTE ($ 230.000)</b>, pagadera a la suscripción del presente contrato y DIEZ (10) cuotas mensuales por valor de 
                        <b>CIENTO CINCUENTA MIL PESOS MCTE ($ 150.000)</b> cada una, las cuales serán canceladas dentro de los CINCO (5) primeros días de cada periodo mensual, a partir del mes de Febrero cinco (5) de dos mil veinticuatro (2024) 
                        hasta su vencimiento en Noviembre cinco (5) de dos mil veinticuatro (2024).
                    </p>
                    
                    <p  style="text-align: justify;"><b>Parágrafo 1. </b>En caso de mora en el pago de una o varias cuotas, LOS PADRES DE FAMILIA Y/O ACUDIENTES pagaran intereses moratorios liquidados a la tasa máxima legal permitida, certificada por la 
                    ...
                    <p  style="text-align: justify;"><b>Parágrafo 1.1: </b>Para los pagos que se realicen a partir del día seis (6) de cada mes, dará inicio al cobro pre-jurídico. <b>Parágrafo 1.2:</b> Para garantizar el pago de la suma de dinero correspondiente, 
                    ...
                    <p  style="text-align: justify;"><b>Parágrafo 3: </b>Las partes contratantes dentro de esta cláusula renuncian a los requerimientos de la constitución en mora de la obligación, a los requerimientos judiciales y extrajudiciales.
                    </p>

                    <p  style="text-align: justify;"><b>Parágrafo 4: </b>Este contrato presta merito ejecutivo para las partes contratantes a partir de su firma, al tenor del Artículo 422 del CGP.
                    </p>

                    <p  style="text-align: justify;"><b>SEXTA. LOS PADRES DE FAMILIA Y/O ACUDIENTES, </b>autorizan al COLEGIO o a quien este determine, para que consulte, reporte, procese y divulgue a cualquier central de información del sector educativo 
                        ...
                        del presente contrato con el COLEGIO, con los sectores comercial y financieros colombianos; así como también el reporte a la Secretaria de Educación en el sistema integrado de matrícula SIMAT, en el cual se realiza la gestión de la 
                    ...
                    <p  style="text-align: justify;"><b>SEPTIMA. DERECHOS Y OBLIGACIONES DE LOS PADRES DE FAMILIA Y/O ACUDIENTES, </b>En cumplimiento del Decreto 1286 de 2005, artículos 2 y 3 y conforme a las normas vigentes para el servicio educativo 
                    ...
                    <p  style="text-align: justify;"><b>OCTAVA-DERECHOS Y OBLIGACIONES DEL (LA) ESTUDIANTE: </b>En cumplimiento de las normas vigentes para el servicio educativo y en concordancia con el objeto del presente contrato, el (la) 
                    ...
                    <p  style="text-align: justify;"><b>NOVENA: DERECHOS Y OBLIGACIONES DEL COLEGIO: </b>En cumplimiento de las normas vigentes para el servicio educativo y en concordancia con el objeto del presente contrato, el COLEGIO tiene 
                    ...
                    <p  style="text-align: justify;"><b>PARAGRAFO:</b>Los PADRES DE FAMILIA Y/O ACUDIENTES son los responsables por daños, lesiones personales o accidentes provocados por el ESTUDIANTE, así mismo, a sus compañeros, al personal 
                    ...
                    <p  style="text-align: justify;"><b>DECIMA: DEVOLUCIONES Y REINTEGROS:</b>A) DE MATRICULA: Cuando los PADRES DE FAMILIA Y/O ACUDIENTES hayan pagado lo correspondiente a la matrícula y este no ingrese a estudiar, el COLEGIO, 
                    ...
                    <p  style="text-align: justify;">B) PENSIONES: cuando los PADRES Y/O ACUDIENTES hayan pagado de manera anticipada el monto de las pensiones escolares y por motivos disciplinarios será retirado el ESTUDIANTE del 
                    ...
                    <p  style="text-align: justify;"><b>DECIMA PRIMERA: REGULACION DE INFORMACION DE BASES DE DATOS:</b>Los padres y/o acudientes declaramos que hemos autorizado al Colegio para que publique fotos de nuestros (os) 
                    ...
                    <p  style="text-align: justify;"><b>DECIMA SEGUNDA- MANEJO DE BASES DE DATOS:</b>Sus datos personales están siendo tratados bajo lo dispuesto en la legislación vigente sobre protección de los datos personales a los 
                        ...
                        <br><br><b>DECIMA CUARTA: EFECTOS:</b> El presenta contrato presta merito ejecutivo y por lo tanto los PADRES y/o ACUDIENTES serán responsables y asumirán todos los costos derivados del cobro pre jurídico y jurídico que con ocasión de su incumplimiento se llevare a presentar. 
                    ...
                    <p  style="text-align: justify;"><b>ASI MISMO EL PADRE DE FAMILIA O ACUDIENTE AUTORIZA AL COLEGIO LA NOTIFICACIÓN MEDIANTE CORREO ELECTRONICO</b>, a través del siguiente correo electrónico y/o a la siguiente dirección <b><?php echo "".$fila['correo']." - ".$fila['direccion']?> </b>. 
                    </p>

                    <p  style="text-align: justify;">Para todos los efectos legales las partes aceptan y definen como domicilio contractual de las mismas la ciudad de Tuluá – Valle, y recibirán notificaciones en las direcciones que indican en el pie de sus respectivas firmas. 
                    </p>
...
$dompdf->stream("Contrato_".$fila['nombre']." ".$fila['apellido'].".pdf", array("Attachment" => false));
