                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label for="jornada">Jornada</label>
                                <select class="form-control" id="exampleSelect1" name="jornada">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label for="password">Dpto. Nacimiento</label><br>
                                    <select name="dpto_nac" id="dpto_nac" class="form-control" required>
                                        <option value="">Selecciona una opción</option>
                                        <?php
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="ciu_nac" id="ciu_nac" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="ciu_exp" id="ciu_exp" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <select name="id_eps" id="id_eps" class="form-control" required>
                                        ...
                                        $sqleps = "SELECT * FROM eps ORDER BY descripcion ASC ";
                                        $resultadoeps = mysqli_query($conexion, $sqleps);
                                        while ($consultaeps = mysqli_fetch_array($resultadoeps)) {
                                            echo '<option value="' . $consultaeps['descripcion'] . '">' . $consultaeps['descripcion'] . '</option>';
                                        }
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="exampleSelect1" name="rh">
                                <?php echo "<option>Seleccione una opción</option>"; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="sisben" id="sisben" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <label for="discapacidad">¿Posee alguna discapacidad?</label>
                                <select class="form-control" id="exampleSelect1" name="discapacidad" required>
                                <?php echo "<option>Seleccione una opción</option>"; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label for="conviven">Personas que viven en el hogar</label>
                                <select class="form-control" id="exampleSelect1" name="conviven">
                                <?php echo "<option>Seleccione una opción</option>"; ?>
                        ...
                        <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <select name="madre" id="madre" class="form-control" >
                                        ...
                                        $sqleps = "SELECT * FROM acudientes ORDER BY nombre ASC";
                                        $resultadoeps = mysqli_query($conexion, $sqleps);
                                        while ($consultaeps = mysqli_fetch_array($resultadoeps)) {
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <select name="acudiente3" id="acudiente3" class="form-control" required>
                                        <option value="">Selecciona una opción</option>
                                        <?php

                                        include("db.php");

                                        $sqlacu = "SELECT * FROM acudientes ORDER BY nombre ASC ";
                        ...
                        <div class="col-sm-6">
                            ...
                            <label for="parentezco">Parentezco Acudiente</label>
                                <select class="form-control" id="exampleSelect1" name="parentezco">
                                <?php echo "<option>Seleccione una opción</option>"; ?>
