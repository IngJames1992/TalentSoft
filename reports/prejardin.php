...
<body id="page-top">
                ...
                <div class="table-responsive">
                    ...
                    <tr rowspan="3">
                        <td ><a href=""><center><img src="https://i.ibb.co/gtNzjS7/Logo-Colegio-Talentos.jpg" alt="cropped-Recurso-2-1024x273-2" border="0"></center></a>
                        </td>
                    ...
                    <div>
                        <table border="1" width="100%" cellspacing="0" style ="font-size:65%">
                            ...
                            <?php
                                ...
                                $filas=1;
                                $result = mysqli_query($conexion, "SELECT * FROM alumnos WHERE id_grado='9' ORDER BY apellido ASC ");
